...
f_burdell = Person("Mr. Burdell", 53)
m_burdell = Person("Mrs. Burdell", 53)

george_p = Person("George P. Burdell", 25, f_burdell, m_burdell)
...
print(george_p.mother.age)
print(george_p.father.age)
