...
#Add your code here!
def volume_and_area(dimen_dic):
    length = dimen_dic['length']
    width = dimen_dic['width']
    height = dimen_dic['height']
    dimen_dic['volume'] = length * width * height
    dimen_dic['area'] = 2 * ((length * width) + (length*height) + (width*height))
