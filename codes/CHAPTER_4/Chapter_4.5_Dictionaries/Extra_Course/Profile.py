...
#Add your code here!
def complete_profile(person_info):
    first = person_info["first"]
    middle = person_info["middle"]
    last = person_info["last"]
    title = person_info["title"]
    name = "{} {}".format(first, last)
    full_name = "{} {} {} {}".format(title, first, middle, last)
    short_name = "{} {}".format(first[0], last)
    
    person_info["name"] = name
    person_info["full_name"] = full_name
    person_info["short_name"] = short_name
